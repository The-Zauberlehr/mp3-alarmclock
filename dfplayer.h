 ...
 */
#define QUERY_NUM_SD_TRACKS 0x48
...
typedef enum {
    /**
     * @brief Single play mode (play once and stop).
     */
    MODE_SINGLE_PLAY     = 0x01,
    /**
     * @brief Loop all mode (repeat all tracks).
     */
    MODE_LOOP_ALL        = 0x01,
    /**
     * @brief Folder repeat mode (repeat tracks in a folder).
     */
    MODE_FOLDER_REPEAT   = 0x00,
    /**
     * @brief Single repeat mode (repeat one track).
     */
    MODE_SINGLE_REPEAT   = 0x03,
    /**
     * @brief Random mode.
     */
    MODE_RANDOM          = 0x04
 ...
 *
 * @param dfplayer The DFPlayer instance to get the playback mode for.
 * @return The current playback mode.
 */
uint16_t dfplayer_get_playback_mode(dfplayer_t *dfplayer);
/**
...
void dfplayer_sleep(dfplayer_t *dfplayer);
/**
 * @brief Resumes playback.
 *
 * @param dfplayer The DFPlayer instance to resume playback on.
 */
void dfplayer_resume(dfplayer_t *dfplayer,uint16_t track);
